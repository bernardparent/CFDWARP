...
typedef struct {
  ...
  gl_cycle_t cycle;
  gl_model_t model;
  bool MODEL_FLUID_READ,MODEL_CHEM_READ,MODEL_METRICS_READ,MODEL_TRANSPORT_READ,CYCLE_FLUID_READ,MODEL_EMFIELD_READ,CYCLE_EMFIELD_READ,MODEL_BEAM_READ,DISC_FLUID_READ,DISC_EMFIELD_READ,DISC_RESCONV_READ,DISC_RESTIME_READ;
