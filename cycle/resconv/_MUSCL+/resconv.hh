#define _RESCONV_METHOD "MUSCL+ with flux FVS+ [parent2012a], FDS+ [parent2013a], and primitive interpolation TVD [anderson1986a], WENO [jiang1996a], CWENO [dumbser2007a], AOWENO [balsara2016a], and eigenvalue conditioning HARTEN, GNOFFO [gnoffo2004a], PECLET [parent2017a], PASCAL [parent2018a]"
