...
\begin{table}[!htbp]
  ...
  \midrule  
  \multirow{2}{*}{6} &  \multirow{2}{*}{ $\rm e^- + NH_3  $   } & ${\rm ln}~T_{\rm e}$  & \tiny    5.9071    5.9360    5.9766    6.0577    6.1905    7.1726    9.5791   10.3891   10.6531   10.8588   11.0817   11.3371   11.6296   11.9751   12.3970   12.8861    13.9987 \\
  &  & ${\rm ln}~\mu_{\rm e}N$   & \tiny 54.3945   54.4120   54.4383   54.4922   54.5891   54.9095   55.8537   56.1118   55.9944   55.8154   55.6260   55.4560   55.3278   55.2486   55.2031   55.1513    54.9856 \\
    \midrule  
  \multirow{2}{*}{7} &  \multirow{2}{*}{ $\rm e^- + NH_3(v)  $   } & ${\rm ln}~T_{\rm e}$  & \tiny 6.0890    6.3959    6.4717    6.6029    7.0223    8.7333    9.9210   10.3135   10.5100   10.6798   10.8661   11.0835   11.3367   11.6282   11.9736   12.3951  13.9987
 \\
  &  & ${\rm ln}~\mu_{\rm e}N$   & \tiny     54.5130   54.7361   54.7986   54.9162   55.1938   55.8470   56.2612   56.2627   56.1487   55.9944   55.8159   55.6288   55.4584   55.3288   55.2489   55.2026     54.9855
 \\
     \midrule  
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_H.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_H_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_H2.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_H2_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_O2.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_O2_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_NO.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_NO_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_N.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_N_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_O.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_O_error.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_NH3_NH3v.png}}
\caption{Results for the mobility of electrons in ${\rm NH_3}$ and ${\rm NH_3}$$(v)$. The BOLSIG+ calculation uses electron impact cross sections from the Morgan database in Ref.\ \citen{jcp:2012:morgan}.}
\label{fig:mobility_NH3}
\end{figure}
%
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_H2O.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_C2H4.png}}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{figs/mobility_CO.png}}
