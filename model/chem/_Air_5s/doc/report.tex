...
\tablecaption{Dunn-Kang (1973) 5-species 17-reaction high-temperature air model \cite{nasa:1973:dunn,aiaaconf:1987:Bussing}.}
\begin{tabular}{ccccc} 
\toprule
...
\begin{center}
\begin{threeparttable}
\tablecaption{Park (1993) 5-species high-temperature air model \cite{jtht:1993:park}.}
...
\begin{center}
\begin{threeparttable}
\tablecaption{Boyd (2007) 5-species high-temperature air model.}
\begin{tabular}{cccccccc} 
\toprule
No. & Reaction\tnote{(b)} & Forward          & Backward    & $A$, $\textrm{cm}^3\cdot(\textrm{mole}\cdot \textrm{s})^{-1}\cdot \textrm{K}^{-n}$ & $n$ & $E$, cal/mole~\tnote{(a)} & Ref.\\ 
~   & ~                   & Control. Temp.   & Control. Temp.\tnote{(c)} &~ & ~ & ~ & ~\\
