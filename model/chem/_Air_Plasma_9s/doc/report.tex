...
\begin{table}
  ...
  \begin{threeparttable}
    \tablecaption{Macheret (2007) 8-species 22-reactions air plasma chemical model.\tnote{a}}
    \label{tab:macheret}
    \fontsizetable
...
\begin{table}
  \center\fontsizetable
  \begin{threeparttable}
    \tablecaption{Bowersox (2024) 9-species 21-reaction air plasma chemical model.\tnote{a}}
...
\begin{table}
  \center\fontsizetable
  \begin{threeparttable}
    \tablecaption{Rajendran (2022) 8-species 22-reactions air plasma chemical model.\tnote{a}}
    \label{tab:rajendran}
    \fontsizetable
    \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}lll}
    \toprule
