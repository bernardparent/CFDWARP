...
\begin{center}
\begin{threeparttable}
\tablecaption{Rodriguez 11-species plasma chemical model (corrected reaction rates for the Kim 2021 model)\tnote{a,b,c}}
\begin{tabular}{cccccccc} 
\toprule
...
\begin{center}
\begin{threeparttable}
\tablecaption{Rodriguez-Park 11-species plasma chemical model (corrected reaction rates for the Parent-Park model)\tnote{a,b,c}}
\begin{tabular}{cccccccc} 
\toprule
