...
\tablecaption{Dunn-Kang (1973) 11-species 31-reaction high-temperature air model \cite{nasa:1973:dunn,aiaaconf:1987:Bussing}.}
\begin{tabular}{ccccc} 
\toprule
...
\begin{table}[t]
  \center\fontsizetable
  \begin{threeparttable}
    \tablecaption{Townsend ionization rates for N$_2$, O$_2$, and NO.\tnote{a}}
    \label{tab:townsend}
    \fontsizetable
    \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}lll}
    \toprule
    ...
    \end{tabular*}
\begin{tablenotes}
\item[{a}] Notation and units: $E^\star$ is the reduced effective electric field ($E^\star\equiv|\vec{E}|/N$) in units of V$\cdot$m$^2$.
