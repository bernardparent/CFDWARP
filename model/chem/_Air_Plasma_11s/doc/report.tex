...
\begin{center}
\begin{threeparttable}
\tablecaption{Parent (2021) 11-species high-temperature air model.}
...
10 & $\rm N + O \rightleftarrows NO^+ + e^- $ & $T$  & 5.3 $\cdot$ 10$^{12}$  & 0.0 & $32000 \, R$ & $\sqrt{T_{\rm e} T_{\rm v}}$ & $5.87 \cdot 10^{17}$ & $-0.2998$ & $100 \, R$ \\

11 & $\rm O + O \rightleftarrows O_2^+ + e^- $ & $T$  & 1.1 $\cdot$ 10$^{13}$  & 0 & $81200 \, R$ & $\sqrt{T_{\rm e} T_{\rm v}}$ & $1.52 \cdot 10^{18}$ & $-0.3411$ & $881\, R$\\

12 & $\rm N + N \rightleftarrows N_2^+ + e^- $ & $T$ & 2.0 $\cdot$ 10$^{13}$  & 0 & $67700 \, R$ & $\sqrt{T_{\rm e} T_{\rm v}}$ &  $4.65 \cdot 10^{17}$ & $-0.2493$ & $7\, R$ \\
