...
\begin{center}
\begin{threeparttable}
\tablecaption{Rodriguez 11-species plasma chemical model (alternative reaction rates for the Kim 2021 model)\tnote{a,b}}
\begin{tabular}{cccccccc} 
\toprule
...
\begin{table}[!ht]
  \center\fontsizetable
  \begin{threeparttable}
    \tablecaption{Coordinates of control points for monotone cubic spline interpolation of reaction rates\tnote{a}.}
...
\end{minipage}\\
\midrule
  \multirow{2}{*}{30} &  \multirow{2}{*}{ $\rm e^- + N_2 \rightleftarrows N_2^+ + e^- + e^-$   } & Forward &  \begin{minipage}[t]{0.3\textwidth}\raggedright\fontsize{7pt}{7pt}\selectfont  
    9.8483, 9.9819, 10.2842, 10.4379, 10.7181, 11.0848, 11.1312, 11.1948, 11.4360, 11.5971, 14.9141
 \end{minipage}  & \begin{minipage}[t]{0.3\textwidth}\raggedright\fontsize{7pt}{7pt}\selectfont 
  -49.4041, -44.5753, -37.3445, -34.6995, -30.8554, -26.0214, -24.7535, -23.5733, -21.3724, -20.4532, -13.9209
\end{minipage}\\
\midrule
  \multirow{2}{*}{30} &  \multirow{2}{*}{ $\rm e^- + O_2 \rightleftarrows O_2^+ + e^- + e^-$   } & Forward &  \begin{minipage}[t]{0.3\textwidth}\raggedright\fontsize{7pt}{7pt}\selectfont  
...
\end{minipage}\\
\midrule
  \multirow{2}{*}{30} &  \multirow{2}{*}{ $\rm e^- + NO \rightleftarrows NO^+ + e^- + e^-$   } & Forward &  \begin{minipage}[t]{0.3\textwidth}\raggedright\fontsize{7pt}{7pt}\selectfont  
        9.5015,    9.7154,    9.9574,   10.1947,   10.3715,   10.5141,   10.5788,   10.7837,   11.2280,   11.6627,   12.1515,   13.9673

 \end{minipage}  & \begin{minipage}[t]{0.3\textwidth}\raggedright\fontsize{7pt}{7pt}\selectfont 
    -45.3314,  -38.8204,  -34.3367,  -31.3595,  -29.4711,  -27.4630,  -25.8461,  -23.1037,  -20.3218,  -18.7708,  -17.6469,  -15.9836
