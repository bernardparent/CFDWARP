...
The units for $A$ are in $[\textrm{cm}^{3b}\cdot (\textrm{mole}\cdot \textrm{s})^{-b} \cdot \textrm{K}^{-n} ]$ where $b=1$ for two-body reactions and 
$b=2$ for three-body reactions. On the other hand, the units for $E$ are in $[\rm {cal}/{mole}]$.
