...
\begin{table*}[!htbp]
  ...
  \begin{threeparttable}
    \tablecaption{$\rm Ar$ electron impact processes with available cross-section data.}
    \label{tab:tableAr}
    \fontsizetable
...
\caption{$E/N$ results for $\rm Ar$, showing reduced electric field as a function of the electron temperature. Experimental $\rm Ar$ data points are taken from \citen{ajp:1977:milloy} and simulation data from \citen{pr:1995:boeuf}.}
...
\subsection{Vibrationally Excited Nitrogen molecule (${\rm N_2}$$(v)$)}

Collision cross-sections are sourced from the Morgan LXCat database for all cases but the vibrational excitation cross sections are replaced with those of Ref. \cite{psst:2012:laporta}.

\begin{figure}[!htbp]
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.32]{electronimpact_figs/electronimpact_figureN2v1.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.32]{electronimpact_figs/electronimpact_figureN2v2.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.32]{electronimpact_figs/electronimpact_figureN2v3.png}}
\caption{$E/N$ results for the first three levels of vibrationally excited $\rm N_2$, showing the effect of the ionization fractions on the reduced electric field as a function of the electron temperature}
\label{fig:electronimpact_N2vib123}
\end{figure}
...
\begin{table*}[!htbp]
  \center\fontsizetable
  \begin{threeparttable}
    \tablecaption{$\rm NH_3$, $\rm NH_3$$(v)$ electron impact processes with available cross-section data.}
    \label{tab:tableNH3}
    \fontsizetable
    \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}llll}
    \toprule
...
\begin{figure}[!htbp]
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureC2H4.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureC2H4_error.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureC2H4_drift.png}}
...
\begin{figure}[!htbp]
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureH2O.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureH2O_error.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureH2O_drift.png}}
...
\begin{figure}[!htbp]
\centering
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureCO.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureCO_error.png}}
\subfigure[]{\includegraphics[width=0.99\linewidth, angle=0.0,scale=0.49]{electronimpact_figs/electronimpact_figureCO_drift.png}}
...
\\
  ...
  \multirow{2}{*}{3} &  \multirow{2}{*}{ $\rm e^- + N_2(v=1) $   } & ${\rm ln}~T_{\rm e}$  & \tiny              5.7037
    5.9886
    6.2586
    6.6853
    7.0816
...
\\
  \midrule    
    ...
    \multirow{2}{*}{3} &  \multirow{2}{*}{ $\rm e^- + N_2(v=2) $   } & ${\rm ln}~T_{\rm e}$  & \tiny       5.7037     5.9886
    6.2586
    6.6853
    7.0816
    7.4328
...
\\
  ...
  \multirow{2}{*}{3} &  \multirow{2}{*}{ $\rm e^- + N_2(v=3) $   } & ${\rm ln}~T_{\rm e}$  & \tiny        5.7037     5.9886
    6.2586
    6.6853
    7.0816
    7.4328
