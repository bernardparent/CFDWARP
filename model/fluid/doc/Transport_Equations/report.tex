...
\begin{equation}
  ...
  = 
  - \rho_{\rm e} h_{\rm e} \mu_{\rm e} \vec{E}_j 
  -\frac{5 N_{\rm e} k_{\rm B}^2 T_{\rm e} \mu_{\rm e} }{2 |C_{\rm e}| } \frac{  \partial T_{\rm e}}{\partial x_j} 
  -\frac{5 k_{\rm B}^2 T_{\rm e}^2 \mu_{\rm e}}{2 |C_{\rm e}| } \frac{\partial N_{\rm e}  }{\partial x_j} 
\end{equation}
% 
...
\begin{equation}
  ...
  = 
  - \sum_j \rho_{\rm e} h_{\rm e} \tilde{\mu}_{ij}^{\rm e} \vec{E}_j 
...
The total electron energy loss is not simply $Q_{\rm e-t}+Q_{\rm e-n}$ as obtained from Eqs.\ (\ref{eqn:Qe-t}) and (\ref{eqn:Qe-n}) because $Q_{\rm e-n}$ includes the loss of electron energy due to elastic collisions with the neutrals. We thus need to subtract the loss of electron energy due to elastic collisions from $Q_{\rm e-n}$. This can be done by finding the fraction of $E/N$ within  $Q_{\rm e-n}$ that is responsible for elastic collisions. To do so, equate the first term on the RHS of (\ref{eqn:Qe-t}) with $T\rightarrow0$ to the RHS of (\ref{eqn:Qe-n}):
%
\begin{equation}
...
\end{equation}
%
Then, we can subtract $(E^\star_k)^2_{\rm tr}$ from $(E^\star_k)^2$ before adding $Q_{\rm e-n}$ to $Q_{\rm e-t}$:
%
\begin{equation}
\frameeqn{
Q_{\rm e}
...
F_i = \left[ \begin{array}{c}
    ...
    \vdots\\
    \rho_\ns \vec{V}_i \alb
    \rho\vec{V}_i \vec{V}_1^{\rm n} + \delta_{i1} P^\star \\
    \vdots \\
    \rho\vec{V}_i \vec{V}_3^{\rm n}  + \delta_{i3} P^\star \alb
