...
\section{Thermionic Emission Boundary Condition}
...
%
\begin{equation}
    J_{\rm emit}= \lambda_R A_0 T_{\rm w}^2 \exp(-W/(k_{\rm B} T_{\rm w})) 
\end{equation}
%
...
First, define $\chi$ as a coordinate perpendicular to the surface and pointing from the surface towards the plasma. 
