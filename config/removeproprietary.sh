...
echo "Removing proprietary directory .././model/chem/_C2H4_Air_30s"
rm -rf .././model/chem/_C2H4_Air_30s 
cp -a _proprietary .././model/chem/_C2H4_Air_30s 
( printf "current C2H4_Air_30s\nEND" ) > .././model/chem/_C2H4_Air_30s/.config 
echo "Removing proprietary directory .././model/chem/_C2H4_Air_Plasma_36s"
rm -rf .././model/chem/_C2H4_Air_Plasma_36s 
cp -a _proprietary .././model/chem/_C2H4_Air_Plasma_36s 
( printf "current C2H4_Air_Plasma_36s\nEND" ) > .././model/chem/_C2H4_Air_Plasma_36s/.config 
...
( printf "current H2_Air_Plasma_13s\nEND" ) > .././model/chem/_H2_Air_Plasma_13s/.config 
echo "Removing proprietary directory .././model/chem/_H2_Air_Plasma_18s"
rm -rf .././model/chem/_H2_Air_Plasma_18s 
cp -a _proprietary .././model/chem/_H2_Air_Plasma_18s 
( printf "current H2_Air_Plasma_18s\nEND" ) > .././model/chem/_H2_Air_Plasma_18s/.config 
echo "Removing proprietary directory .././model/chem/_H2_Cs_Air_Plasma_15s"
rm -rf .././model/chem/_H2_Cs_Air_Plasma_15s 
cp -a _proprietary .././model/chem/_H2_Cs_Air_Plasma_15s 
( printf "current H2_Cs_Air_Plasma_15s\nEND" ) > .././model/chem/_H2_Cs_Air_Plasma_15s/.config 
echo "Removing proprietary directory .././model/chem/_H2_He_CH4_Plasma_13s"
...
echo "Removing proprietary directory .././model/chem/_NH3_Plasma_19s"
rm -rf .././model/chem/_NH3_Plasma_19s 
cp -a _proprietary .././model/chem/_NH3_Plasma_19s 
( printf "current NH3_Plasma_19s\nEND" ) > .././model/chem/_NH3_Plasma_19s/.config 
...
( printf "current NH3_Plasma_32s\nEND" ) > .././model/chem/_NH3_Plasma_32s/.config 
echo "Removing proprietary directory .././model/chem/_NH3_Plasma_34s"
rm -rf .././model/chem/_NH3_Plasma_34s 
cp -a _proprietary .././model/chem/_NH3_Plasma_34s 
( printf "current NH3_Plasma_34s\nEND" ) > .././model/chem/_NH3_Plasma_34s/.config 
...
echo "Removing proprietary directory .././model/emfield/_Epotential-Bfixed_old"
rm -rf .././model/emfield/_Epotential-Bfixed_old 
cp -a _proprietary .././model/emfield/_Epotential-Bfixed_old 
( printf "current Epotential-Bfixed_old\nEND" ) > .././model/emfield/_Epotential-Bfixed_old/.config 
