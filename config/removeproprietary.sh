...
echo "Removing proprietary directory .././model/chem/_NH3_Plasma_21s"
rm -rf .././model/chem/_NH3_Plasma_21s 
cp -a _proprietary .././model/chem/_NH3_Plasma_21s 
( printf "current NH3_Plasma_21s\nEND" ) > .././model/chem/_NH3_Plasma_21s/.config 
