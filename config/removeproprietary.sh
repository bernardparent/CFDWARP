...
echo "Removing proprietary directory .././model/chem/_Air_Plasma_12s_42r_Dunn-Kang-Macheret"
rm -rf .././model/chem/_Air_Plasma_12s_42r_Dunn-Kang-Macheret 
cp -a _proprietary .././model/chem/_Air_Plasma_12s_42r_Dunn-Kang-Macheret 
( printf "current Air_Plasma_12s_42r_Dunn-Kang-Macheret\nEND" ) > .././model/chem/_Air_Plasma_12s_42r_Dunn-Kang-Macheret/.config 
